...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기
        *   사전에 정의된 예외클래스 외 개발자가 원하는 명칭의 예외 클래스를 작성하는 것이 가능하다.
        *   extends Exception 으로 예외처리 클래스를 상속받아 더 구체적인 예외 이름을 정의하는 것 */
...
//            et.checkEnoughMoney(50000,-10000);     <- 가진 돈을 음수로 입력하는 경우
